    ...
    <div class="w3-container">
        <table class="table middle">
            ...
            <tr>
                ...
                <td>ZHOU Zijing</td>
                <td>
                    <select class="w3-select" id="21912808">
            ...
            <tr>
                <th scope="row">21700639</th>
                <td>Bob Jason</td>
                <td>
                    <select class="w3-select" id="21700639" disabled>
                        <option value="Present">Present</option>
                        <option value="Retard" selected>Retard</option>
                        <option value="Absent">Absent</option>
                    </select></td>
                <td><a class="fa fa-file" href="resources/images/avatar-01.jpg" aria-hidden="true"></a></td>
            </tr>
            <%
                String flag = request.getParameter("flag");
//                List<>
                if (flag.equals("creation")){

                }else if (flag.equals("modification")){

                }else if (flag.equals("consultation")){
